...
A function can receive parameters and use them inside its body.

When the function finishes, it can return a value to the code that called it.
...
`This function receives a parameter and returns a string.`
