...
<p class="home-kicker">Personal documentation workspace</p>
...
<ul class="home-entry-list">
  <li><a href="/memory/zvec-memory-plan"><span><strong>zvec 记忆检索改造方案</strong><span>长期记忆检索链路和工程改造记录。</span></span></a></li>
  <li><a href="/memory/dashscope-embedding-v4-guide"><span><strong>text-embedding-v4 接入指南</strong><span>向量模型接入、配置和排查参考。</span></span></a></li>
  <li><a href="/ranran-gsap-migration"><span><strong>Ranran GSAP 迁移计划</strong><span>动画项目迁移过程中的关键记录。</span></span></a></li>
  <li><a href="/docs-ui-refresh-plan"><span><strong>文档站界面升级方案</strong><span>本次视觉升级的目标和验收标准。</span></span></a></li>
</ul>

</div>
</div>

<p class="home-note">适合长期阅读的页面，别搞得花里胡哨。入口清楚，正文舒服，才是真能用的文档站。</p>
